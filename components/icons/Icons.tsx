...
export const BuildingIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 22h16"/><path d="M6 18v-4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v4"/><path d="M12 18V10a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v8"/><path d="M12 2v2"/><path d="M8 2v2"/><path d="M16 2v2"/>
  </svg>
);
...
export const SparkleIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.5 2.5L8 8l-5.5 1.5L8 11l1.5 5.5L11 11l5.5-1.5L11 8zM17 17l-1.5 2.5L14 17l1.5-2.5z"/>
        <path d="M5 3v4"/>
        <path d="M19 17v4"/>
    </svg>
);
